...
%load('Subject2_VicDS');
load('Subject2_UsbDS');
load('Subject2_VicNautilusDS');
load('Subject2_NautilusDS');
...
setimevideo0 = dsu.etime(find(dsu.event==1,1,'first'));
vic.stime = (vic.vtime-e.vtime)+e.stime;
